    ...
    public class GraphSaveUtility
    {
        ...
        public void SaveGraph(string fileName)
        {
            ...
            else
            {
                ...
                container.DialogueNodeDatas = dialogueContainerObject.DialogueNodeDatas;
                container.ExposedProperties = dialogueContainerObject.ExposedProperties;
                container.CommentBlockDatas = dialogueContainerObject.CommentBlockDatas;
        ...
        private bool SaveNodes(string fileName, DialogueContainer dialogueContainerObject)
        {
            ...
            {
                dialogueContainerObject.DialogueNodeDatas.Add(new DialogueNodeData
                {
                    NodeGUID = node.GUID,
        ...
        private void SaveCommentBlocks(DialogueContainer dialogueContainer)
        {
            foreach (var block in CommentBlocks)
            {
                ...
                dialogueContainer.CommentBlockDatas.Add(new CommentBlockData
                {
                    ChildNodes = nodes,
                    Title = block.title,
        ...
        {
            foreach (var perNode in _dialogueContainer.DialogueNodeDatas)
            {
            ...
            for (var i = 0; i < Nodes.Count; i++)
            {
                ...
                for (var j = 0; j < connections.Count(); j++)
                {
                    ...
                    targetNode.SetPosition(new Rect(
                        _dialogueContainer.DialogueNodeDatas.First(x => x.NodeGUID == targetNodeGUID).Position,
        ...
        private void GenerateCommentBlocks()
        {
            ...
            foreach (var commentBlockData in _dialogueContainer.CommentBlockDatas)
            {
