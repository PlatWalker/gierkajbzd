...
namespace jbzd.Dialogues.Editor.Save
{
    public class GraphSaveDataSO : ScriptableObject
    {
        ...
        [field: SerializeField][field: SerializeReference] public List<GroupEditorData> Groups { get; set; } = new();
        [field: SerializeField][field: SerializeReference] public List<NodeEditorData> Nodes { get; set; } = new();
