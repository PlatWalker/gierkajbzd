...
namespace jbzd.Plugins.DropdownAttributes.Core.Scripts
{
    ...
    public class DropdownAttribute : PropertyAttribute
    {
        ...
        public string ActionToPerformOnValueChange;
        public List<Object> List = new List<Object>();
        public int SelectedID = -1;
        public GetItemNameCallback GetItemName = null;

        public DropdownAttribute(string listPath, string actionToPerformOnValueChange)
        {
            ActionToPerformOnValueChange = actionToPerformOnValueChange;
            ListPath = listPath;
        ...
        //Uncomment if needed in future. Let's you assign name of property by getting to its object
